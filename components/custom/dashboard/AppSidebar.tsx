    ...
    <Sidebar>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
            ...
            <SidebarMenuButton className={`h-12 gap-3 hover:bg-slate-100 ${path==('/dashboard/settings')?'bg-slate-100':null}`}>
            ...
            <SidebarMenuButton className={`h-12 gap-3 hover:bg-slate-100 ${path==('/dashboard/profile')?'bg-slate-100':null}`}>
